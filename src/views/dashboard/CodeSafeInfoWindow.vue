      ...
      <el-row style="padding-right:20px;">
        ...
        <el-col :span="6">
          <el-form-item label="IP" label-width="50px">
            <el-input v-model="queryArgs.logicAddr" placeholder="IP " size="small" />
          </el-form-item>
        </el-col>
        <el-col :span="6">
        ...
        <el-col :span="6">
          <el-form-item label="缺陷名称">
            <el-input v-model="queryArgs.vulnTitle" placeholder="缺陷名称 " size="small" />
          </el-form-item>
        </el-col>
        <el-col v-if="parentComponentParam.vulnClass=='3'" :span="6">
  ...
  data() {
    return {
      ...
      tableThead: [// 漏洞明细
        ...
        { 'id': '3', 'field': 'bizName', 'fieldType': 'text', 'text': '业务系统', 'align': 'left' },
        { 'id': '4', 'field': 'vulnTitle', 'fieldType': 'text', 'text': '缺陷名称', 'align': 'left' },
        { 'id': '5', 'field': 'vulnDesc', 'fieldType': 'text', 'text': '缺陷说明', 'align': 'left' },
        { 'id': '6', 'field': 'riskLevelLabel', 'fieldType': 'text', 'text': '危险级别', 'align': 'left' },
