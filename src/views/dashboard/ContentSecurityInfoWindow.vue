    ...
    <el-dialog
        ...
        <el-form label-width="90px">
          <el-row style="padding-right:20px;">
            ...
            <el-col :span="8">
              <el-form-item label="不合规内容">
                <el-input  placeholder="不合规内容 " v-model="queryArgs.vulnDesc" size="small"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row style="padding-right:20px;">
            <el-col :span="8">
              <el-form-item label="关键字">
                <el-input  placeholder="关键字 " v-model="queryArgs.vulnTitle" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="业务系统">
                <el-input  placeholder="业务系统 " v-model="queryArgs.bizName" size="small"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row style="padding-right:20px;">
    ...
    data(){
        return{
            ...
            tableThead: [//漏洞明细
                ...
                { 'id': '3', 'field': 'vulnDesc', 'fieldType': 'text', 'text': '不合规内容', 'align': 'left' },
                { 'id': '4', 'field': 'vulnTitle', 'fieldType': 'text', 'text': '关键字', 'align': 'left' },
                { 'id': '11', 'field': 'bizName', 'fieldType': 'text', 'text': '业务系统', 'align': 'left' },
