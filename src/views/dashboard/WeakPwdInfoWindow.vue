          ...
          <el-row style="padding-right:20px;">
            ...
            <el-col :span="6">
              <el-form-item label="账号">
                <el-input  placeholder="账号 " v-model="queryArgs.account" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="弱口令 ">
                <el-input  placeholder="弱口令 " v-model="queryArgs.weakPwd" size="small"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
    ...
    data(){
        return{
            ...
            tableThead: [//漏洞明细
                ...
                { 'id': '3', 'field': 'account', 'fieldType': 'text', 'text': '账号', 'align': 'left' },
                { 'id': '4', 'field': 'weakPwd', 'fieldType': 'text', 'text': '弱口令', 'align': 'left' },
