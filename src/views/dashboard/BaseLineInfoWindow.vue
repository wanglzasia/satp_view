          ...
          <el-row style="padding-right:20px;">
            ...
            <el-col :span="6">
              <el-form-item label="IP " label-width="50px">
                <el-input  placeholder="IP " v-model="queryArgs.logicAddr" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="资产类型 " label-width="80px">
                <el-cascader
            ...
            <el-col :span="6">
              <el-form-item label="问题名称 ">
                <el-input  placeholder="问题名称 " v-model="queryArgs.vulnTitle" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="合规项编码 ">
                <el-input  placeholder="合规项编码 " v-model="queryArgs.itemNo" size="small"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
    ...
    data(){
        return{
            ...
            tableThead: [//漏洞明细
                ...
                { 'id': '4', 'field': 'vulnTitle', 'fieldType': 'text', 'text': '问题名称', 'align': 'left' },
                { 'id': '5', 'field': 'bizName', 'fieldType': 'text', 'text': '所属业务系统', 'align': 'left' },
                { 'id': '6', 'field': 'itemNo', 'fieldType': 'text', 'text': '合规项编码', 'align': 'left' },
                { 'id': '8', 'field': 'itemContent', 'fieldType': 'text', 'text': '合规项内容', 'align': 'left' },
                { 'id': '9', 'field': 'itemStandard', 'fieldType': 'text', 'text': '安全合规要求', 'align': 'left' },
                { 'id': '10', 'field': 'itemScope', 'fieldType': 'text', 'text': '对象类别', 'align': 'left' },
                { 'id': '11', 'field': 'vendor', 'fieldType': 'text', 'text': '扫描工具厂商', 'align': 'left' },
                { 'id': '12', 'field': 'dcvrTime', 'fieldType': 'datetime', 'text': '发现时间', 'align': 'left' },
                { 'id': '13', 'field': 'rectStatLabel', 'fieldType': 'text', 'text': '处置状态', 'align': 'left' },
                { 'id': '14', 'field': 'rectTime', 'fieldType': 'datetime', 'text': '处置时间', 'align': 'left' }
            ],
    ...
    methods: {
        ...
        setTitle(){
          ...
          if(viewType == "vuln"){
            ...
            titleContent = "【"+bizName+"】安全基线问题明细";
          }
          $self.probInfoTitle = year+month+titleContent;
        }
    },
    created() {
