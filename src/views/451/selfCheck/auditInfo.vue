        ...
        >
          ...
          <template>
            <el-row>
              <el-col :span="22">
                <el-form-item>
                  <el-select v-model="formObj.isOk" placeholder="审核结果，请选择">
                    <el-option
            ...
            <el-row>
              <el-col :span="3" align="center">
                <el-form-item>
                  <el-input v-model="formObj.auditAdvice" type="textarea" placeholder="审核意见" clearable />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
...
export default {
  ...
  created() {
    this.id = this.$route.query.busiId
  ...
  methods: {
    ...
    onSubmit() {
      const $self = this
      if (!this.formObj.isOk) {
        this.$message.warning(`请选择审核结果 ！`)
        return
      }
      if (!this.formObj.auditAdvice) {
        this.$message.warning(`请填写审核意见 ！`)
        return
      }
      this.formObj.taskId = this.taskId
      this.selfCheckLoading = true
      this.$store.dispatch('selfCheck/auditOpr', this.formObj).then(response => {
