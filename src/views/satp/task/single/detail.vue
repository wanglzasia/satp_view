        ...
        <el-card>
          ...
          <table class="satp-table-detail">
            ...
            <tr>
              ...
              <td>{{ taskId }}</td>
              <th>任务类型</th>
              <td>{{ SATP_TaskTypeFormat(taskType) }}</td>
              <th>任务来源</th>
            ...
            <tr>
              ...
              <td>2</td>
              <th>任务开始时间</th>
              <td>{{ SATP_DateTimeFormat(taskInfo.startTime) }}</td>
            </tr>
            ...
            <tr>
              ...
              <td>2</td>
              <th>任务结束时间</th>
              <td>{{ SATP_DateTimeFormat(taskInfo.endTime) }}</td>
            </tr>
          ...
          <el-tabs v-model="activeName">
            <el-tab-pane label="检查项范围" name="second">
              <!--检查项-->
              <div>
                <satp-datagrid
                  ref="task-item-grid"
            ...
            <el-tab-pane label="执行范围" name="third">
...
export default {
  ...
  methods: {
    ...
    toList() {
      this.$router.push({ path: '/satp-task/' + this.taskType + '/list/' + this.taskType })
    }
  }
}
</script>
