    ...
    <div class="app-container">
      <el-card>
        ...
        <div style="padding-top: 30px;">
          ...
          <el-form ref="resultForm" :model="auditParams" label-position="right" label-width="120px" size="small">
            <el-row>
              <el-col :span="12">
              ...
              <el-col :span="12">
                <el-form-item label="方案提交人">
                  <el-input v-model="auditParams.reportName" placeholder="方案提交人" readonly="readonly" />
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="备注">
                  <el-input v-model="auditParams.auditNote" type="textarea" placeholder="备注" :readonly="true" />
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
        ...
        <div style="text-align: center;padding-top: 30px;">
          <span>
            ...
            <el-button type="primary" size="small" @click="save">{{ typeStr }}上报</el-button>
          </span>
        </div>
      </el-card>
    </div>
...
export default {
  data() {
    return {
      ...
      saveUrl: 'vulnReinforce/reinforceProjOrResultReport',
  ...
  methods: {
    ...
    save() {
      ...
      params.taskType = this.addParams.taskType
    ...
    getWfTaskVarialbe() {
      this.$store.dispatch(this.taskVariableUrl, { taskId: this.taskId }).then(resp => {
        ...
        this.auditParams.reportName = resp.auditName
        this.auditParams.auditNote = resp.auditNote
      }).catch(
      )
    },
    // 查询加固省份
